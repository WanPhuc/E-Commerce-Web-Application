  ...
  submit(){
    ...
    this.cateService.createCategory(dto).subscribe({
      next:()=>{
        ...
        this.toast.show(this.translate.instant('ui.admin.createCategorySuccess'),'success');
        this.router.navigate(['/admin/category']);
      },error:(err)=>{
        this.submiting.set(false);
        this.toast.show(err?.error?.message || this.translate.instant('ui.admin.createCategoryFailed'),'error');
      }
    })
  }
