...
public class AdminService : IAdminService
{
    ...
    public async Task<ApiResponse<AdminDashboardDto>> GetDashboardStatsAsync(CancellationToken ct = default)
    {
        ...
        return ApiResponse<AdminDashboardDto>.Success(dashboard, "Success", 200, SuccessCodes.Admin.DashboardRetrieved);
    }
    public async Task<ApiResponse<DashboardChartDto>> GetChartAsync(DashboardRanger range, CancellationToken ct = default)
    {
        var now = DateTime.UtcNow;
        ...
        return ApiResponse<DashboardChartDto>.Success(chart, "Success", 200, SuccessCodes.Admin.ChartRetrieved);
